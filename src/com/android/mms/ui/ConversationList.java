...
import com.android.mms.reinvented.mms.fragments.request.RequestByEmail;
...
import com.android.mms.reinvented.mms.adapter.MDAdapter;
...
public class ConversationList extends ListActivity implements DraftCache.OnDraftChangedListener {
	...
	ImageView view = (ImageView)findViewById(android.R.id.home);
		...
		final ViewGroup header1 = (ViewGroup) inflater.inflate(R.layout.header,
				mDrawerList, false);
		mDrawerList.addHeaderView(header1, null, false);
		...
		MDIcons = getResources().obtainTypedArray(R.array.nav_drawer_icons);

		icons = new ArrayList<Icons>();

		icons.add(new Icons(MDTitles[0], MDIcons.getResourceId(0, -1)));

		icons.add(new Icons(MDTitles[1], MDIcons.getResourceId(1, -1)));
		
		icons.add(new Icons(MDTitles[2], MDIcons.getResourceId(2, -1)));

		icons.add(new Icons(MDTitles[3], MDIcons.getResourceId(3, -1)));	
		
		icons.add(new Icons(MDTitles[4], MDIcons.getResourceId(4, -1)));	

		// Recycle the typed array
		MDIcons.recycle();

		// setting the nav drawer list adapter
		adapter = new MDAdapter(getApplicationContext(), icons);
	...
	final ViewGroup header2 = (ViewGroup) inflater2.inflate(R.layout.header2,
...

		{
			...
			public void onDrawerClosed(View view) {
				...
				getActionBar().setTitle(R.string.blanktext);
	...
	private void selectItem(int position) {
		...
		case 2:
			if (mIsSmsEnabled) {
				...
				if (mComposeDisabledToast == null) {
					mComposeDisabledToast = Toast
							.makeText(this, R.string.compose_disabled_toast,
									Toast.LENGTH_SHORT);
				}
		...
		case 3:
				...
				Intent contacts = new Intent("android.intent.action.MAIN");
				contacts.setComponent(ComponentName
						.unflattenFromString("com.android.contacts/com.android.contacts.activities.PeopleActivity"));
		...
		case 4:
				...
				Intent hangouts = new Intent("android.intent.action.MAIN");
				hangouts.setComponent(ComponentName
						.unflattenFromString("com.google.android.talk/com.google.android.apps.babel.phone.BabelHomeActivity"));
