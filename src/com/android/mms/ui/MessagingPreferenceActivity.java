...
public class MessagingPreferenceActivity extends PreferenceActivity
    ...
    private PreferenceCategory mEmoji;
    ...
    private void updateSmsEnabledState() {
        ...
        mEmoji.setEnabled(mIsSmsEnabled);
    ...
    private void loadPrefs() {
        ...
        mEmoji = (PreferenceCategory)findPreference("pref_key_emoji");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.clear();
        if (mIsSmsEnabled) {
            menu.add(0, MENU_RESTORE_DEFAULTS, 0, "Restore")
